...
This code includes the required MATALB scripts for calculating the velocity and lenght scales in [1]. The mathematical and physical explanation of this code is provided in [1]. 
